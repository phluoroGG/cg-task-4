...
public class Matrix3f {
    ...
    public Matrix3f(final float[][] values) {
        matrix = new float[length][length];
        for (int i = 0; i < matrix.length; i++) {
    ...
    public void add(final Matrix3f other) {
        for (int row = 0; row < matrix.length; row++) {
            for (int col = 0; col < matrix[0].length; col++) {
    ...
    public void minus(final Matrix3f other) {
        for (int row = 0; row < matrix.length; row++) {
            for (int col = 0; col < matrix[0].length; col++) {
                matrix[row][col] -= other.matrix[row][col];
            }
    ...
    public void multiply(final Matrix3f other) {
        float[][] values = new float[matrix.length][matrix[0].length];
        for (int row = 0; row < matrix.length; row++) {
            for (int col = 0; col < matrix[0].length; col++) {
                values[row][col] = matrix[row][0] * other.matrix[0][col] +
    ...
    public Vector3f solveGaussian(final Vector3f vector) {
