...
public class Matrix4f {
    ...
    public Vector3f multiplyMatrix4ByVector3(final Vector3f vertex) {
        Vector4f vector = new Vector4f(vertex.vector[0], vertex.vector[1], vertex.vector[2], 1);
        Vector4f newVector = this.multiply(vector);
        return new Vector3f(newVector.vector[0] / newVector.vector[3],
                newVector.vector[1] / newVector.vector[3],
                newVector.vector[2] / newVector.vector[3]);
    }
